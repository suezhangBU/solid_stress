...
close all
clc
%altered code to take specific image name --exp SZ076
...
deformedZstack= cropZ(userInput2, path2, filename2, folderloc2,segment1_2,image_start2,image_end2);
...
%save([filename2 '_ABAQUSintersection.mat'], 'ABAQdeform', 'finalDeform','radiusUN') % NAME OF FILE NEEDED FOR "MAKE BOUNDARY MICROGEL V1"
save([filename2 '_ABAQUSintersection.mat']) 
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
function zStack= cropZ(userInput,path, filename_largest_image, folderloc, segment1,is,ie)
...
%     ie=95; %index of the last file you want to pick
    ...
    for ii=is:ie %size(II_M,3)
        ...
        filename_segment=[segment1 num2str(ii,'%2.f') '.tif'];
